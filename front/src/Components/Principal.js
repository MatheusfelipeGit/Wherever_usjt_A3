...
function RightSide() {
  ...
  return (
    ...
    <div className="interface">
      ...
      <h2 className="sub-titulo"> Olá somos Wherever , estamos aqui para te ajudar a ter sua melhor experiencia
       e apreciar os melhores momentos. Veja algumas de nossas dicas e avaliações sobre restaurantes e locais 
       descontraídos que você pode conhecer. </h2>
